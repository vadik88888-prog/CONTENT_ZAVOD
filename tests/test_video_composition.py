...
def test_creative_preview_and_final_render_the_same_compiled_plan(tmp_path: Path) -> None:
    ...
    assert preview_manifest.plan_hash == final_manifest.plan_hash == compiled.plan_hash
    assert preview_manifest.parity_signature == final_manifest.parity_signature == compiled.parity_signature
